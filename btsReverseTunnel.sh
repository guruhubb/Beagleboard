# *** NOT USED ***
# reverse ssh by using the following command: ssh -f -N -T -R13200:localhost:22 yourpublichost.example.com or username@ip_address
# once done you can ssh -p 13200 username@localhost
#!/bin/bash
if [ -z "$SUDO_USER" ]; then
